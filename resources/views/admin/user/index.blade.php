    ...
    <div class="card main-background">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
          ...
          <a data-href="{{ route('admin.user.form') }}" class="btn btn-info btn-md transform-search">
            <i class="ti-plus"></i>
          </a>
        </div>
        <br>
          ...
          @if ($records->count() > 0)
            <table class="table table-hover">
              ...
              <tbody>
                ...
                @php
                    $path       = 'storage/user/' . $record->image;
                    $id         = $record->id;
                    $name       = $record->name;
                ...
                <tr>
                    ...
                    <td>{{ $name }}</td>
                    <td>
                        <img src="{{ asset($path) }}" alt="" style="width: 140px; height: 70px">
                    </td>
                    ...
                    <td style="position: relative">
                        ...
                        name="sequence" 
                        data-id="{{ $id }}"
                        data-href="{{ route("admin.slider.updateSequence") }}"
                    ...
                    <td>
                        ...
                        data-href="{{ route('admin.slider.form', $params) }}"
                        ...
                        <button type="button" 
                                ...
                                data-id="{{ $id }}"
                                data-name="{{ $name }}"
                                data-href="{{ route("admin.slider.deleteData") }}"
