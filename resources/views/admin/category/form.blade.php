...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="d-flex">
            <a class="btn btn-secondary transform-search" href="javascript:void(0)" data-href="{{ route('admin.category.index') }}">
            ...
            <div class="app-page-title" style="margin: 0px 30px">Quản Lý / Category / Thêm mới</div>
        </div>
        <hr class="mb-4">
        ...
        <form action="#" method="POST" id="categoryForm">
            ...
            @endif
            <div class="row g-4 settings-section" style="background-color: #dcdde1; padding-bottom: 20px">
                    ...
                    <div class="app-card app-card-settings shadow-sm p-4">
                        <div class="app-card-body">
                            @foreach ($blade['inputs'] as $col => $value)
                                ...
                                @endswitch
                            @endforeach
                            <button type="button" onclick="save(this)" data-href="{{ route('admin.category.save') }}" class="btn app-btn-primary">Lưu thay đổi</button>
                        </div>
                    <!--//app-card-->
                </div>
            </div>
